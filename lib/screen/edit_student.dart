...
class _EditStudentState extends State<EditStudent> {
  ...
  void initState() {
    setState(() {
      _userNameController.text = widget.studentModel.name;
      _userContactController.text = widget.studentModel.contact;
      _userDescriptionController.text = widget.studentModel.description;
    });
    super.initState();
  }
...
// Add button and Clear Button
  ...
  showSnackBar() {
    ScaffoldMessenger.of(context)
        .showSnackBar(const SnackBar(content: Text('Student details edited')));
  }
}
